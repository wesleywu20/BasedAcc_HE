...
vlog -reportprogress 300 -work work $path/../hvl/mem_wrapper_tb.sv

vsim -t 1ps -gui -L rtl_work -L work mem_wrapper_tb

add wave -group {Top} -radix hexadecimal sim:/mem_wrapper_tb/*
add wave -group {Wrapper} -radix hexadecimal sim:/mem_wrapper_tb/dut/*
