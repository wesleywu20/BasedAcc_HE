...
def runHEmulSimulation_Verilog():
    print("Running HEmul")
    run_command = ["vsim", "-c", "-do", "../simulation/verification.do"]
    subprocess.run(run_command, check=True)
